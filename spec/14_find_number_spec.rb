...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 0 and max is 9' do
      it 'returns 4' do
        mean = ((0 + 9)/2).floor
        expect(game_guessing.make_guess).to eq(mean)
      end
    end
    ...
    context 'when min is 5 and max is 9' do
      subject(:game_guess) { described_class.new(5, 9, number_guessing) }
      it 'returns 7' do
        min = 5
        max = 9
        mean = ((min + max)/2).floor
        expect(game_guess.make_guess).to eq(mean)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      it 'returns 8' do
        ...
        mean = ((min + max)/2).floor
        expect(game.make_guess).to eq(mean)
      end
    end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      it 'does not update max' do
        expect(low_guess_game.max).to eq(8)
      end
    end
  end
end
